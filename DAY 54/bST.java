...
class Solution {
 public BinaryTreeNode horizontalFlippedTree(BinaryTreeNode root){
        if(root==null || (root.left==null && root.right==null)||root.data==-1||(root.left.data==-1 && root.right.data==-1))return root;
        BinaryTreeNode root2=horizontalFlippedTree(root.left);
